...
User Function ModelCT1()
	...
	For nX := 1 To Len( aLinha )
		...
		ConOut( 'Lendo linha - ' + StrZero( nX, 4 ) + ' : ' + aLinha[ nX, 2 ] )

		oCT1:SETVALUE('CT1_CONTA' , aLinha[ nX, 2 ] )
		oCT1:SETVALUE('CT1_DESC01', aLinha[ nX, 3 ] )
		oCT1:SETVALUE('CT1_CLASSE', aLinha[ nX, 4 ] )
		oCT1:SETVALUE('CT1_NORMAL', aLinha[ nX, 5 ] )
		oCT1:SETVALUE('CT1_CTASUP', aLinha[ nX, 6 ] )
